...
class OpFaculty(models.Model):
    ...
    first_name = fields.Char('First Name', translate=True, required=True, tracking=True)
    middle_name = fields.Char('Middle Name', size=128, required=True, tracking=True)
    last_name = fields.Char('Last Name', size=128, required=True, tracking=True)
    ...
    gender = fields.Selection([
        ('male', 'Male'),
        ('female', 'Female')
    ], 'Gender', required=True, tracking=True)
    ...
    def get_import_templates(self):
        return [{
            ...
            'template': '/gxs_core/static/xls/op_faculty.xls'
        }]