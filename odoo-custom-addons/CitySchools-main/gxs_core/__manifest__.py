...

{
    ...
    'assets': {
        'website.assets_frontend': [
            '/gxs_core/static/src/scss/main.scss',
        ],
        'web.assets_backend': [
            '/gxs_core/static/src/scss/style.scss',
            '/gxs_core/static/src/js/g2_review.js',
            '/gxs_core/static/src/xml/review.xml',
            '/gxs_core/static/src/xml/web_client.xml',
        ],
    },
}
